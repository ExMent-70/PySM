...
class StudentSelection:
    """One student's ordered photo numbers and import provenance."""
...
class SelectionDocument:
    """Selection data bound to one roster, session and photo session."""
    ...
    def apply(
        ...
        *,
        ...
        """Replace or merge a student's choice, preserving number order."""
...
class ImportEntry:
    """Normalized input row shared by manual, CSV and AI import paths."""
