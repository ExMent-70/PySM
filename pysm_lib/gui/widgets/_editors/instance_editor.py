...
class InstanceEditorWidget(BaseEditor):
    ...
    def on_button_click(self):
        ...
        dialog = InstanceSelectionDialog(
            ...
            script_entries=self.context.script_entries,
