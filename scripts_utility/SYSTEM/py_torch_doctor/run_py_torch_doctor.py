...
print("<b>PyTorch GPU Diagnostic Script</b>")
print(f"Python Version: {sys.version}")
print(f"PyTorch Version: {torch.__version__}")


# Test 1: Is CUDA available at all according to PyTorch?
print("\n<b><i>[Test 1] Checking torch.cuda.is_available()</i></b>")
is_available = torch.cuda.is_available()
print(f"Result: {is_available}")

if not is_available:
    print("❌ CRITICAL: PyTorch reports that CUDA is NOT available.")
    ...
    print("✅ SUCCESS: PyTorch can see a CUDA-enabled device.")



# Test 2: How many GPUs does PyTorch see?
print("\n<b><i>[Test 2] Checking torch.cuda.device_count()</i></b>")
try:
...
print("\n<b><i>[Test 3] Getting properties of device 0</i></b>")
...
print("\n<b><i>[Test 4] Attempting a simple tensor operation on 'cuda:0'</i></b>")
if is_available and device_count > 0:
    try:
        ...
        print("✅✅✅ ULTIMATE SUCCESS: All GPU operations are working correctly!")
        
    except Exception as e:
        print("❌❌❌ ULTIMATE FAILURE: A runtime error occurred during the GPU operation.")
