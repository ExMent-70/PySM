# Руководство по использованию скрипта "Операции с папками" (v1.05.03)

## 1. Назначение

Скрипт **"Операции с папками"** — это мощная и гибкая утилита для выполнения файловых операций. Он позволяет копировать или перемещать содержимое одной папки в другую, используя многопоточность для ускорения процесса.
